...
function ProfileModal({ open, onClose }) {
  ...
  async function handleAvatarUpload(event) {
    ...
    try {
      ...
      setStatusText(error?.message || "Failed to upload avatar.");
    } finally {
  ...
  async function handleRemoveAvatar() {
    ...
    try {
      ...
      setStatusText("Avatar removed.");
    } catch (error) {
      setStatusText(error?.message || "Failed to remove avatar.");
    } finally {
  ...
  async function handlePasswordSave(event) {
    ...
    try {
      ...
      setStatusText(error?.message || "Failed to update password.");
    } finally {
