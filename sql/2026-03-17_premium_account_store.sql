...
with catalog (
  ...
  values
    ...
    ('music:egyptian-1', 'Egyptian 1', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 1.mp3', 1, null, '{"trackId":"egyptian-1","trackFile":"/audio/Egyptian 1.mp3"}'::jsonb),
    ('music:egyptian-2', 'Egyptian 2', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 2.mp3', 2, null, '{"trackId":"egyptian-2","trackFile":"/audio/Egyptian 2.mp3"}'::jsonb),
    ('music:egyptian-3', 'Egyptian 3', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 3.mp3', 3, null, '{"trackId":"egyptian-3","trackFile":"/audio/Egyptian 3.mp3"}'::jsonb),
    ('music:egyptian-4', 'Egyptian 4', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 4.mp3', 4, null, '{"trackId":"egyptian-4","trackFile":"/audio/Egyptian 4.mp3"}'::jsonb),
    ('music:egyptian-5', 'Egyptian 5', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 5.mp3', 5, null, '{"trackId":"egyptian-5","trackFile":"/audio/Egyptian 5.mp3"}'::jsonb),
    ('music:egyptian-6', 'Egyptian 6', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Egyptian 6.mp3', 6, null, '{"trackId":"egyptian-6","trackFile":"/audio/Egyptian 6.mp3"}'::jsonb),
    ('music:desert-of-set', 'Desert Of Set', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Desert Of Set.mp3', 7, null, '{"trackId":"desert-of-set","trackFile":"/audio/Desert Of Set.mp3"}'::jsonb),
    ('music:obelisk-of-thunder', 'Obelisk of Thunder', 'Permanent soundtrack unlock with 10-second preview support.', 'music', 'music_track', '/ui/onyx_logo.png', '/audio/Obelisk of Thunder.mp3', 8, null, '{"trackId":"obelisk-of-thunder","trackFile":"/audio/Obelisk of Thunder.mp3"}'::jsonb),
